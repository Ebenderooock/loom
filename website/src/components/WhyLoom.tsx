...
const comparisons = [
  ...
  { category: 'Indexers (Prowlarr)', arr: 'Prowlarr — dedicated .NET app', loom: 'Built in — 542 indexers', loomBetter: true },
  { category: 'Torrent Client', arr: 'qBittorrent / Transmission / etc.', loom: 'Built in — zero dependencies', loomBetter: true },
  { category: 'Requests (Overseerr)', arr: 'Overseerr / Ombi — separate app', loom: 'Planned — built in', loomBetter: null },
  { category: 'Library Cleanup (Maintainerr)', arr: 'Maintainerr — separate app', loom: 'Planned — built in', loomBetter: null },
  { category: 'Analytics (Tautulli)', arr: 'Tautulli — separate app', loom: 'Planned — built in', loomBetter: null },
