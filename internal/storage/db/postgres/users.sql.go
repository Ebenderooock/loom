...
SELECT id, username, password_hash, email, role, created_at, updated_at FROM users WHERE id = $1 LIMIT 1
`
...
SELECT id, username, password_hash, email, role, created_at, updated_at FROM users WHERE username = $1 LIMIT 1
`
