...
const navItems: NavItem[] = [
  ...
  { label: "Workflows", to: "/workflows", keywords: "jobs tasks", Icon: Workflow },
  { label: "Downloads", to: "/downloads", keywords: "torrents clients", Icon: Download },
  { label: "Indexers", to: "/indexers", keywords: "trackers prowlarr", Icon: Radio },
  { label: "Sources", to: "/sources", keywords: "import lists rss", Icon: Database },
  { label: "Import Lists", to: "/import-lists", keywords: "trakt lists rss", Icon: ListChecks },
  { label: "Quality Profiles", to: "/quality-profiles", keywords: "quality", Icon: SlidersHorizontal },
  { label: "Custom Formats", to: "/custom-formats", keywords: "scoring formats", Icon: SlidersHorizontal },
  { label: "Notifications", to: "/notifications", keywords: "discord webhook alerts", Icon: Bell },
